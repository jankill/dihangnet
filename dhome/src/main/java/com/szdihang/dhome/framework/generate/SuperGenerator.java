...
public class SuperGenerator {
    ...
    protected StrategyConfig getStrategyConfig(String tableName) {
        ...
        return new StrategyConfig()
                ...
                //自定义实体父类
                .setSuperEntityClass("com.szdihang.dhome.model.BaseModel")
                // 自定义实体，公共字段
                .setSuperEntityColumns("id")
                .setTableFillList(tableFillList)
                // 自定义 mapper 父类
                .setSuperMapperClass("com.szdihang.dhome.mapper.BaseMapper")
                // 自定义 controller 父类
                .setSuperControllerClass("com.szdihang.dhome.controller.SuperController")
                // 自定义 service 实现类父类
                .setSuperServiceImplClass("com.szdihang.dhome.service.impl.BaseServiceImpl")
                // 自定义 service 接口父类
                .setSuperServiceClass("com.szdihang.dhome.service.BaseService")
    ...
    protected List<TableFill> getTableFills() {
        ...
        tableFillList.add(new TableFill("createBy", FieldFill.INSERT));
        tableFillList.add(new TableFill("updateBy", FieldFill.INSERT_UPDATE));
    ...
    protected DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig()
                ...
                .setUsername("dhome")
                .setPassword("123456")
                .setUrl("jdbc:mysql://127.0.0.1:3306/dhome?characterEncoding=utf8");
    }
